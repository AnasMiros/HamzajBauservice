export default class Focus {
	...
	registerClickEvent() {
		this.getHtmlElement().addEventListener( 'click', ( e ) => {
			if (
				e.target === this.getHtmlElement() &&
				e.target.closest( '#ionos-journey-guide' ) === null
			) {
	...
	moveToTop() {
		const cachedTransition = this.getHtmlElement().style.transition;
